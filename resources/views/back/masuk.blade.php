										 ...
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											<tr>
												...
												<tr>
													...
													<td>5</td>
													<td>membeli</td>
                                                    <td><button data-toggle="modal" data-target="#edit13" class="btn btn-warning">E</button> <button data-toggle="modal" data-target="#del13" class="btn btn-danger">D</button></td>
												</tr>
                                                ...
                                                <div class="modal fade" id="edit13">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="date" id="tanggal" name="tanggal" class="form-control" value="2023-05-18">
                                                            ...
                                                            <input type="text" id="jumlah" name="jumlah" class="form-control" value="5">

                                                            <label for="keterangan">Keterangan</label>
                                                            <input type="text" id="keterangan" name="keterangan" class="form-control" value="membeli">
							...
							<form action="barang_masuk_act.php" method="post">
								...
								<div class="form-group">
									...
									<option selected>Pilih barang</option>
																			<option value="245">Komputer Asus ROG, Uk. 14</option>
																				<option value="243">Mata Bor Flame Garryson, Uk. 50</option>
																				<option value="244">Mata Bor Ball Nosed Cone Garryson, Uk. 17</option>
																			</select>
								</div>
								<div class="form-group">
									<label>Jumlah</label>
